    ...
    def train(self):
        ...
        for frame_idx in pbar:
            ...
            if frame_idx % 50000 == 0:
                ...
                # 保存图片
                figure.savefig(self.p_dir + 'duelingdqn_' + '%d.png' % frame_idx)
            ...
            if frame_idx % 50000 == 0:
                ...
                np.save(self.fig_dir + 'duelingdqn_reward_' + '%d.npy' % frame_idx, reward_tmp)  # 保存为.npy格式
                np.save(self.fig_dir + 'duelingdqn_loss_' + '%d.npy' % frame_idx, losses_tmp)  # 保存为.npy格式
